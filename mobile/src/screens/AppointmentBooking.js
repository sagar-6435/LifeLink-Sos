    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <TouchableOpacity style={styles.moreBtn}>
          <MaterialCommunityIcons name="dots-horizontal" size={20} color="#0f172a" />
        </TouchableOpacity>
      </View>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.doctorCard}>
          <View style={styles.doctorImage}>
            <MaterialCommunityIcons name="doctor" size={40} color="#ef4444" />
          </View>
        ...
        <View style={styles.aiCard}>
          <View style={styles.aiIcon}>
            <MaterialCommunityIcons name="brain" size={18} color="#ef4444" />
          </View>
        ...
        <View style={styles.priceRow}>
          ...
          <View style={styles.paymentIcons}>
            ...
            <View style={[styles.paymentIcon, styles.paymentIconActive]}>
              <MaterialCommunityIcons name="wallet" size={12} color="#0f172a" />
            </View>
          </View>
        </View>
